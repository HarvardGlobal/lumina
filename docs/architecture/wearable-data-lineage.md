...
| LUMINA interpretation | Wearables `1.2.4`, Git `3174e76…`, mapping registry `0.1.1`, schema `1.1.0` | Dataset `mapping_version`, `schema_version`, provenance event | Allows a mapping correction to create a new derived dataset without changing source evidence. |
